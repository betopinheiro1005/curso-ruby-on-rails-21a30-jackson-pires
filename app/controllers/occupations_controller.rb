class OccupationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @occupation.save
        format.html { redirect_to @occupation, notice: 'Profissão criada com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @occupation.update(occupation_params)
        format.html { redirect_to @occupation, notice: 'Profissão atualizada com sucesso!' }
  ...
  def destroy
    @occupation.destroy
    respond_to do |format|
      format.html { redirect_to occupations_url, notice: 'Profissão apagada com sucesso!' }
