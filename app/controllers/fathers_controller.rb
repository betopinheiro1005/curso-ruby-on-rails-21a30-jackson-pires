class FathersController < ApplicationController
  ...
  before_action :set_occupation, only: [:new, :create, :edit, :update]
  ...
  def create
    ...
    respond_to do |format|
      if @father.save
        format.html { redirect_to @father, notice: 'Pai criado com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @father.update(father_params)
        format.html { redirect_to @father, notice: 'Pai atualizado com sucesso!' }
  ...
  def destroy
    @father.destroy
    respond_to do |format|
      format.html { redirect_to fathers_url, notice: 'Pai apagado com sucesso!' }
